...
We build a global **Hot** model similar to to **Warm**, the only diffrence is the size of the data set, which is of `r nrow(hot_data)` observations. 
...
A more detail view of the model with parameters, it is not optimum as the sd includes zero most of the time. The main question is how the model will behave based on new informations. 
